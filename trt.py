...
import webbrowser
webbrowser.open('https://t.me/ABU_HARBA')
...
logo=("""\033[1;91m
        ...
        \033[1;97m    888     8888888P"     888     
         ...
         \033[1;97m   888     888  T88b     888     
          \033[1;97m  888     888   T88b    888\033[1;32m       ABU HARB THE SAD 
\033[1;37m--------------------------------------------------
[~] Telegram   : ABU_HARBA
[~] by : ABU HARB
[~] Tool     : FRRE
...
def menu():
		...
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				...
				os.system('xdg-open https://t.me/ABU_HARBA')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
